...
|              | **Result getCurrentResult()**: returns a Result with the current attributes of the game.                                                                                                                                                                                                                                                                                              |
| Result       | Contains the following: **state:** the state of the game, **lettersTried:** the list of already guessed letters, **displayedWord:** the currently displayed word, where found letters are displayed and the missing ones are replaced by underscores (Example: " c \_ \_ \_ \_ \_ \_ r"), **wrongGuessesLeft:** the amount of remaining wrong guesses before the game ends in defeat. |
